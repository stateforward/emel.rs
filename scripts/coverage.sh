...
MODEL_GENERATION_REPORT="${EMEL_MODEL_GENERATION_COVERAGE_REPORT:-$ROOT_DIR/target/coverage/emel-model-generation.json}"
...
MODEL_OMNIEMBED_REPORT="${EMEL_MODEL_OMNIEMBED_COVERAGE_REPORT:-$ROOT_DIR/target/coverage/emel-model-omniembed.json}"
...
MODEL_GENERATION_COVERAGE_TARGET_DIR="${EMEL_MODEL_GENERATION_COVERAGE_TARGET_DIR:-$ROOT_DIR/target/llvm-cov-target/emel-model-generation}"
...
MODEL_OMNIEMBED_COVERAGE_TARGET_DIR="${EMEL_MODEL_OMNIEMBED_COVERAGE_TARGET_DIR:-$ROOT_DIR/target/llvm-cov-target/emel-model-omniembed}"
...
echo "Running maintained emel-model generation coverage"
run_coverage "$MODEL_GENERATION_COVERAGE_TARGET_DIR" "$MODEL_GENERATION_REPORT" \
  '(^|/)(tools/|crates/emel-io/|crates/emel-gguf/|crates/emel-token/|crates/emel-tensor/|crates/emel-kernels/|crates/emel-model/(src/(lib\.rs|architecture/|catalog/|data\.rs|gemma4/|generation/tests\.rs|generation_audit\.rs|lfm2/|llama/|loader/|moshi/|omniembed/|port_inventory_tests\.rs|qwen3/|sortformer/|tensor/|vocabulary/|whisper/)|tests/|examples/)|sm\.rs$)' \
  --package emel-model

echo "Running maintained emel-model LFM2 family coverage"
run_coverage "$MODEL_LFM2_COVERAGE_TARGET_DIR" "$MODEL_LFM2_REPORT" \
  '(^|/)(tools/|crates/emel-io/|crates/emel-gguf/|crates/emel-token/|crates/emel-tensor/|crates/emel-kernels/|crates/emel-model/(src/(lib\.rs|architecture/|catalog/|data\.rs|gemma4/|generation/|generation_audit\.rs|lfm2/tests\.rs|llama/|loader/|moshi/|omniembed/|port_inventory_tests\.rs|qwen3/|sortformer/|tensor/|vocabulary/|whisper/)|tests/|examples/)|sm\.rs$)' \
  --package emel-model

echo "Running maintained emel-model Qwen3 family coverage"
run_coverage "$MODEL_QWEN3_COVERAGE_TARGET_DIR" "$MODEL_QWEN3_REPORT" \
  '(^|/)(tools/|crates/emel-io/|crates/emel-gguf/|crates/emel-token/|crates/emel-tensor/|crates/emel-kernels/|crates/emel-model/(src/(lib\.rs|architecture/|catalog/|data\.rs|gemma4/|generation/|generation_audit\.rs|lfm2/|llama/|loader/|moshi/|omniembed/|port_inventory_tests\.rs|qwen3/tests\.rs|sortformer/|tensor/|vocabulary/|whisper/)|tests/|examples/)|sm\.rs$)' \
  --package emel-model

echo "Running maintained emel-model Gemma4 family coverage"
run_coverage "$MODEL_GEMMA4_COVERAGE_TARGET_DIR" "$MODEL_GEMMA4_REPORT" \
...
echo "Running maintained emel-model OmniEmbed family coverage"
run_coverage "$MODEL_OMNIEMBED_COVERAGE_TARGET_DIR" "$MODEL_OMNIEMBED_REPORT" \
  '(^|/)(tools/|crates/emel-io/|crates/emel-gguf/|crates/emel-token/|crates/emel-tensor/|crates/emel-kernels/|crates/emel-model/(src/(lib\.rs|architecture/|attention_family/|catalog/|data\.rs|gemma4/|generation/|generation_audit\.rs|lfm2/|llama/|loader/|moshi/|port_inventory_tests\.rs|qwen3/|sortformer/|tensor/|vocabulary/|whisper/|omniembed/(sm\.rs|tests\.rs))|tests/|examples/))' \
  --package emel-model -- omniembed::
...
echo "Running maintained emel-tensor serialized dtype coverage"
run_coverage "$TENSOR_DTYPE_COVERAGE_TARGET_DIR" "$TENSOR_DTYPE_REPORT" \
