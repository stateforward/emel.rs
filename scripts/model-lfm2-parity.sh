...
RUST_OBSERVER="${CARGO_TARGET_DIR:-$ROOT_DIR/target}/debug/examples/lfm2_observer"
...
"$RUST_OBSERVER" --fixture "$EMEL_CPP_SOURCE/$LFM2_RELATIVE" >"$BUILD_DIR/rust.230m.fixture"
...
"$RUST_OBSERVER" --fixture "$EMEL_CPP_SOURCE/$LFM2_1_2B_RELATIVE" >"$BUILD_DIR/rust.1_2b.fixture"
diff -u "$BUILD_DIR/cpp.1_2b.fixture" "$BUILD_DIR/rust.1_2b.fixture"
"$BUILD_DIR/cpp-observer" --validation >"$BUILD_DIR/cpp.validation"
"$RUST_OBSERVER" --validation >"$BUILD_DIR/rust.validation"
