...
fn hash_metadata_value(
    ...
    match descriptor.kind() {
        ...
        MetadataKind::Int8 | MetadataKind::Int16 | MetadataKind::Int32 | MetadataKind::Int64 => {
            hash_bytes(
                hash,
                &loader
...
fn hash_array(loader: &mut Loader, key: &[u8], descriptor: MetadataDescriptor, hash: &mut u64) {
    let kind = descriptor
        .array_element_kind()
    ...
    if kind == ElementKind::String {
        loader
            .process_event(VisitStringArray::new(key, |index: u32, value: &[u8]| {
