...
sml! {
    TextTokenizer<'event> {
        ...
        "binding_preprocessor_decision"_s <= "binding_preprocessor"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) / bind_preprocessor,
        "binding_encoder"_s <= "binding_preprocessor_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_preprocessor_error_none],
        "errored"_s <= "binding_preprocessor_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_preprocessor_error_invalid_request],
        "errored"_s <= "binding_preprocessor_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_preprocessor_error_model_invalid],
        "errored"_s <= "binding_preprocessor_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_preprocessor_error_backend_error],
        "errored"_s <= "binding_preprocessor_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_preprocessor_error_unknown],
        "binding_encoder_decision"_s <= "binding_encoder"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) / bind_encoder,
        "idle"_s <= "binding_encoder_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_encoder_error_none] / mark_bind_success,
        "errored"_s <= "binding_encoder_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_encoder_error_invalid_request],
        "errored"_s <= "binding_encoder_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_encoder_error_model_invalid],
        "errored"_s <= "binding_encoder_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_encoder_error_backend_error],
        "errored"_s <= "binding_encoder_decision"_s + completion<EventBindRuntime>(EventBindRuntime<'event>) [bind_encoder_error_unknown],
        "preprocess_decision"_s <= "preprocessing"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) / dispatch_preprocess,
        "errored"_s <= "preprocess_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [preprocess_rejected_no_error] / set_backend_error,
        "errored"_s <= "preprocess_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [preprocess_reported_error] / set_error_from_preprocess,
        "errored"_s <= "preprocess_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [preprocess_fragment_count_invalid] / set_invalid_request_error_from_preprocess_decision,
        "prefix_decision"_s <= "preprocess_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [preprocess_success],
        "encoding_ready"_s <= "prefix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [bos_ready] / append_bos,
        "errored"_s <= "prefix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [bos_no_capacity] / set_invalid_request_error_from_prefix_decision,
        "errored"_s <= "prefix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [bos_invalid_id] / set_invalid_id_error_from_prefix_decision,
        "encoding_ready"_s <= "prefix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [no_prefix],
        "suffix_decision"_s <= "encoding_ready"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [no_more_fragments],
        "errored"_s <= "encoding_ready"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [more_fragments_no_capacity] / set_invalid_request_error_from_encoding_ready,
        "errored"_s <= "encoding_ready"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [more_fragments_token_invalid] / set_invalid_request_error_from_encoding_ready,
        "encoding_token_fragment"_s <= "encoding_ready"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [more_fragments_token_valid],
        "encoding_raw_fragment"_s <= "encoding_ready"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [more_fragments_raw],
        "encoding_ready"_s <= "encoding_token_fragment"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) / append_fragment_token,
        "encoding_raw_decision"_s <= "encoding_raw_fragment"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) / dispatch_encode_raw_fragment,
        "errored"_s <= "encoding_raw_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [encode_rejected_no_error] / set_invalid_id_error_from_encoding_raw_decision,
        "errored"_s <= "encoding_raw_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [encode_reported_error] / set_error_from_encode,
        "errored"_s <= "encoding_raw_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [encode_count_invalid] / set_invalid_request_error_from_encoding_raw_decision,
        "encoding_ready"_s <= "encoding_raw_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [encode_success] / commit_encoded_fragment,
        "finalizing"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [sep_ready] / append_sep,
        "errored"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [sep_no_capacity] / set_invalid_request_error_from_suffix_decision,
        "errored"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [sep_invalid_id] / set_invalid_id_error_from_suffix_decision,
        "finalizing"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [eos_ready] / append_eos,
        "errored"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [eos_no_capacity] / set_invalid_request_error_from_suffix_decision,
        "errored"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [eos_invalid_id] / set_invalid_id_error_from_suffix_decision,
        "finalizing"_s <= "suffix_decision"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) [no_suffix],
        "done"_s <= "finalizing"_s + completion<EventTokenizeRuntime>(EventTokenizeRuntime<'event>) / finalize,
