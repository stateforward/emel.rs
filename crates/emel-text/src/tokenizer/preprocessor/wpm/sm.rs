...
// --- machine TextTokenizerPreprocessorWpm from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/sm.hpp ---
/// Runtime event shell (TODO: fields from events/detail).
#[derive(Debug, Default, Clone)]
pub struct EventPreprocessRuntime;

sml! {
    TextTokenizerPreprocessorWpm {
...
/// Context for `TextTokenizerPreprocessorWpm` (TODO: context.hpp / detail.hpp).
#[derive(Debug, Default)]
pub struct TextTokenizerPreprocessorWpmContext {
    // TODO: port fields from matching context.hpp / detail.hpp in emel.cpp
}

impl TextTokenizerPreprocessorWpmStateMachineContext for TextTokenizerPreprocessorWpmContext {
    fn begin_preprocess(&mut self, _event: &EventPreprocessRuntime) -> Result<(), ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::begin_preprocess
        todo!(
            "TODO: port action `begin_preprocess` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    fn build_specials(&mut self, _event: &EventPreprocessRuntime) -> Result<(), ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::build_specials
        todo!(
            "TODO: port action `build_specials` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    fn build_specials_backend_error(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::build_specials_backend_error
        todo!(
            "TODO: port guard `build_specials_backend_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn build_specials_invalid_request_error(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::build_specials_invalid_request_error
        todo!(
            "TODO: port guard `build_specials_invalid_request_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn build_specials_ok(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::build_specials_ok
        todo!(
            "TODO: port guard `build_specials_ok` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn build_specials_unknown_error(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::build_specials_unknown_error
        todo!(
            "TODO: port guard `build_specials_unknown_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn ensure_last_error_from_build_specials_decision(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::ensure_last_error
        todo!(
            "TODO: port action `ensure_last_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    ...
    fn fragments_buffer_missing(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::fragments_buffer_missing
        todo!(
            "TODO: port guard `fragments_buffer_missing` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn fragments_buffer_present(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::fragments_buffer_present
        todo!(
            "TODO: port guard `fragments_buffer_present` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn fragments_capacity_exceeds_limit(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::fragments_capacity_exceeds_limit
        todo!(
            "TODO: port guard `fragments_capacity_exceeds_limit` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn fragments_capacity_nonzero(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::fragments_capacity_nonzero
        todo!(
            "TODO: port guard `fragments_capacity_nonzero` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn fragments_capacity_within_limit(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::fragments_capacity_within_limit
        todo!(
            "TODO: port guard `fragments_capacity_within_limit` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn fragments_capacity_zero(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::fragments_capacity_zero
        todo!(
            "TODO: port guard `fragments_capacity_zero` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn has_specials(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::has_specials
        todo!(
            "TODO: port guard `has_specials` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn mark_done(&mut self, _event: &EventPreprocessRuntime) -> Result<(), ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::mark_done
        todo!(
            "TODO: port action `mark_done` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    fn no_specials(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::no_specials
        todo!(
            "TODO: port guard `no_specials` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn on_unexpected_from_build_specials_decision(&mut self) -> Result<(), ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::on_unexpected
        todo!(
            "TODO: port action `on_unexpected` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    ...
    fn parse_special_disabled(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::parse_special_disabled
        todo!(
            "TODO: port guard `parse_special_disabled` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn parse_special_enabled(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::parse_special_enabled
        todo!(
            "TODO: port guard `parse_special_enabled` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn partition_backend_error(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::partition_backend_error
        todo!(
            "TODO: port guard `partition_backend_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn partition_invalid_request_error(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::partition_invalid_request_error
        todo!(
            "TODO: port guard `partition_invalid_request_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn partition_no_specials(&mut self, _event: &EventPreprocessRuntime) -> Result<(), ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::partition_no_specials
        todo!(
            "TODO: port action `partition_no_specials` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    fn partition_non_bpe_parse_special(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::partition_non_bpe_parse_special
        todo!(
            "TODO: port action `partition_non_bpe_parse_special` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    fn partition_non_bpe_skip_special(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::partition_non_bpe_skip_special
        todo!(
            "TODO: port action `partition_non_bpe_skip_special` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    fn partition_ok(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::partition_ok
        todo!(
            "TODO: port guard `partition_ok` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn partition_unknown_error(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::partition_unknown_error
        todo!(
            "TODO: port guard `partition_unknown_error` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn reject_invalid_from_request_buffer_decision(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::reject_invalid
        todo!(
            "TODO: port action `reject_invalid` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
    ...
    fn request_text_empty(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::request_text_empty
        todo!(
            "TODO: port guard `request_text_empty` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn request_text_nonempty(&self, _event: &EventPreprocessRuntime) -> Result<bool, ()> {
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp::request_text_nonempty
        todo!(
            "TODO: port guard `request_text_nonempty` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/guards.hpp"
        )
    }
    fn set_empty_partition_result_from_partitioning_no_specials_input_decision(
        ...
        // TODO: convert from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp::set_empty_partition_result
        todo!(
            "TODO: port action `set_empty_partition_result` from emel.cpp/src/emel/text/tokenizer/preprocessor/wpm/actions.hpp"
        )
    }
