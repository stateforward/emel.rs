...
sml! {
    TextTokenizerPreprocessorBpe {
        ...
        "partitioning_select"_s <= "build_specials_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [build_specials_ok],
        ...
        "partitioning_bpe_no_specials_input_decision"_s <= "partitioning_select"_s + completion<EventPreprocessRuntime<'dispatch>> [no_specials],
        "partition_parse_special_decision"_s <= "partitioning_select"_s + completion<EventPreprocessRuntime<'dispatch>> [has_specials],
        "errored"_s <= "partitioning_select"_s + completion<EventPreprocessRuntime<'dispatch>> / ensure_last_error_from_partitioning_select,
        "partitioning_bpe_with_specials_parse_input_decision"_s <= "partition_parse_special_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [parse_special_enabled],
        "partitioning_bpe_with_specials_skip_input_decision"_s <= "partition_parse_special_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [parse_special_disabled],
        ...
        "partition_decision"_s <= "partitioning_bpe_no_specials_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [request_text_empty] / set_empty_partition_result_from_partitioning_bpe_no_specials_input_decision,
        "partitioning_bpe_no_specials"_s <= "partitioning_bpe_no_specials_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [request_text_nonempty],
        "errored"_s <= "partitioning_bpe_no_specials_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> / ensure_last_error_from_partitioning_bpe_no_specials_input_decision,
        "partition_decision"_s <= "partitioning_bpe_with_specials_parse_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [request_text_empty] / set_empty_partition_result_from_partitioning_bpe_with_specials_parse_input_decision,
        "partitioning_bpe_with_specials_parse_special"_s <= "partitioning_bpe_with_specials_parse_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [request_text_nonempty],
        "errored"_s <= "partitioning_bpe_with_specials_parse_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> / ensure_last_error_from_partitioning_bpe_with_specials_parse_input_decision,
        "partition_decision"_s <= "partitioning_bpe_with_specials_skip_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [request_text_empty] / set_empty_partition_result_from_partitioning_bpe_with_specials_skip_input_decision,
        "partitioning_bpe_with_specials_skip_special"_s <= "partitioning_bpe_with_specials_skip_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> [request_text_nonempty],
        "errored"_s <= "partitioning_bpe_with_specials_skip_input_decision"_s + completion<EventPreprocessRuntime<'dispatch>> / ensure_last_error_from_partitioning_bpe_with_specials_skip_input_decision,
        "partition_decision"_s <= "partitioning_bpe_no_specials"_s + completion<EventPreprocessRuntime<'dispatch>> / partition_bpe_no_specials,
        "partition_decision"_s <= "partitioning_bpe_with_specials_parse_special"_s + completion<EventPreprocessRuntime<'dispatch>> / partition_bpe_with_specials_parse_special,
        "partition_decision"_s <= "partitioning_bpe_with_specials_skip_special"_s + completion<EventPreprocessRuntime<'dispatch>> / partition_bpe_with_specials_skip_special,
