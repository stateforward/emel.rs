...
sml! {
    TextEncodersBpe<'event> {
        ...
        "encode_input_policy_decision"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [text_non_empty],
        ...
        "encode_table_prepare"_s <= "encode_input_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [preprocessed] / prepare_tables,
        "errored"_s <= "encode_input_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [not_preprocessed] / reject_invalid_encode_from_encode_input_policy_decision,
        "errored"_s <= "encode_input_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / reject_invalid_encode_from_encode_input_policy_decision,
        "encode_path_decision"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_prepare_ok],
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_prepare_backend_error] / ensure_last_error_from_encode_table_prepare,
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_prepare_invalid_argument_error] / ensure_last_error_from_encode_table_prepare,
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_prepare_model_invalid_error] / ensure_last_error_from_encode_table_prepare,
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_prepare_unclassified_error_code] / ensure_last_error_from_encode_table_prepare,
        "encode_direct_word_policy_decision"_s <= "encode_path_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [ignore_merges_enabled],
        "encode_exec"_s <= "encode_path_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>),
        "encode_result_decision"_s <= "encode_direct_word_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [direct_word_token_available] / run_encode_ignore_merges,
        "encode_merge_input_capacity_decision"_s <= "encode_direct_word_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>),
        "encode_exec"_s <= "encode_merge_input_capacity_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_symbol_capacity_within_limit],
        ...
        "encode_result_decision"_s <= "encode_exec"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / run_encode_merge_path,
