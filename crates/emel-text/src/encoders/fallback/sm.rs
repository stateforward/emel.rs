...
sml! {
    TextEncodersFallback<'a> {
        ...
        "encode_table_prepare"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime<'a>> [text_non_empty] / prepare_tables,
        "encode_exec"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime<'a>> [table_prepare_ok],
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime<'a>> [table_prepare_invalid_argument_error] / ensure_last_error_from_encode_table_prepare,
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime<'a>> [table_prepare_backend_error] / ensure_last_error_from_encode_table_prepare,
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime<'a>> [table_prepare_model_invalid_error] / ensure_last_error_from_encode_table_prepare,
        "errored"_s <= "encode_table_prepare"_s + completion<RuntimeEncodeRuntime<'a>> [table_prepare_unclassified_error_code] / ensure_last_error_from_encode_table_prepare,
        "emit_result_decision"_s <= "encode_exec"_s + completion<RuntimeEncodeRuntime<'a>> / run_encode_exec,
