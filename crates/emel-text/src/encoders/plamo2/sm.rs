...
sml! {
    TextEncodersPlamo2<'a> {
        ...
        "encode_vocab_sync_decision"_s <= "encode_validity_decision"_s + completion<RuntimeEncodeRuntime<'a>> [valid_encode],
        "errored"_s <= "encode_validity_decision"_s + completion<RuntimeEncodeRuntime<'a>> [invalid_encode] / reject_invalid_encode_from_encode_validity_decision,
        "errored"_s <= "encode_validity_decision"_s + completion<RuntimeEncodeRuntime<'a>> / reject_invalid_encode_from_encode_validity_decision,
        "encode_precheck_decision"_s <= "encode_vocab_sync_decision"_s + completion<RuntimeEncodeRuntime<'a>> [vocab_changed] / begin_encode_sync_vocab,
        "encode_precheck_decision"_s <= "encode_vocab_sync_decision"_s + completion<RuntimeEncodeRuntime<'a>> [vocab_unchanged] / begin_encode,
        "errored"_s <= "encode_vocab_sync_decision"_s + completion<RuntimeEncodeRuntime<'a>> / reject_invalid_encode_from_encode_vocab_sync_decision,
        "done"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime<'a>> [text_empty] / mark_done_from_encode_precheck_decision,
        "table_policy_decision"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime<'a>> [text_non_empty],
        "errored"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime<'a>> / ensure_last_error_from_encode_precheck_decision,
        "table_sync_exec"_s <= "table_policy_decision"_s + completion<RuntimeEncodeRuntime<'a>> [tables_missing],
        "decode_exec"_s <= "table_policy_decision"_s + completion<RuntimeEncodeRuntime<'a>> [tables_ready],
        "errored"_s <= "table_policy_decision"_s + completion<RuntimeEncodeRuntime<'a>> / ensure_last_error_from_table_policy_decision,
        "table_sync_result_decision"_s <= "table_sync_exec"_s + completion<RuntimeEncodeRuntime<'a>> / sync_tables,
        "decode_exec"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [table_sync_ok],
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [table_sync_invalid_argument_error] / ensure_last_error_from_table_sync_result_decision,
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [table_sync_backend_error] / ensure_last_error_from_table_sync_result_decision,
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [table_sync_unclassified_error_code] / ensure_last_error_from_table_sync_result_decision,
        "decode_result_decision"_s <= "decode_exec"_s + completion<RuntimeEncodeRuntime<'a>> / decode_input,
        "done"_s <= "decode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [decode_result_empty_ok] / mark_done_from_decode_result_decision,
        "dp_prepare_exec"_s <= "decode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [decode_result_non_empty_ok],
        "errored"_s <= "decode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [decode_result_invalid_argument_error] / ensure_last_error_from_decode_result_decision,
        "errored"_s <= "decode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [decode_result_backend_error] / ensure_last_error_from_decode_result_decision,
        "errored"_s <= "decode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [decode_result_model_invalid_error] / ensure_last_error_from_decode_result_decision,
        "errored"_s <= "decode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [decode_result_unclassified_error_code] / ensure_last_error_from_decode_result_decision,
        "dp_exec"_s <= "dp_prepare_exec"_s + completion<RuntimeEncodeRuntime<'a>> / prepare_dp,
        "backtrace_exec"_s <= "dp_exec"_s + completion<RuntimeEncodeRuntime<'a>> / run_dp,
        "backtrace_result_decision"_s <= "backtrace_exec"_s + completion<RuntimeEncodeRuntime<'a>> / validate_backtrace,
        "emit_exec"_s <= "backtrace_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [backtrace_ok],
        "errored"_s <= "backtrace_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [backtrace_failed] / mark_backtrace_failed,
        "errored"_s <= "backtrace_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> / ensure_last_error_from_backtrace_result_decision,
        "emit_result_decision"_s <= "emit_exec"_s + completion<RuntimeEncodeRuntime<'a>> / emit_tokens,
        "encode_result_decision"_s <= "emit_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [emit_result_ok] / apply_emit_result_ok,
        "encode_result_decision"_s <= "emit_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [emit_result_failed] / apply_emit_result_failed,
        "errored"_s <= "emit_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> / ensure_last_error_from_emit_result_decision,
        "done"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [encode_result_ok] / mark_done_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [encode_result_invalid_argument_error] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [encode_result_backend_error] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [encode_result_model_invalid_error] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> [encode_result_unclassified_error_code] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime<'a>> / ensure_last_error_from_encode_result_decision,
