...
sml! {
    TextEncodersSpm<'event> {
        ...
        "errored"_s <= "encode_validity_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [invalid_encode] / reject_invalid_encode_from_encode_validity_decision,
        "errored"_s <= "encode_validity_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / reject_invalid_encode_from_encode_validity_decision,
        ...
        "errored"_s <= "encode_vocab_sync_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / reject_invalid_encode_from_encode_vocab_sync_decision,
        "done"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [text_empty] / mark_done_from_encode_precheck_decision,
        "table_policy_decision"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [text_non_empty],
        "errored"_s <= "encode_precheck_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / ensure_last_error_from_encode_precheck_decision,
        "table_sync_exec"_s <= "table_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [tables_missing],
        "encode_prepare_exec"_s <= "table_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [tables_ready],
        "errored"_s <= "table_policy_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / ensure_last_error_from_table_policy_decision,
        "table_sync_result_decision"_s <= "table_sync_exec"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / sync_tables,
        "encode_prepare_exec"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_sync_ok],
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_sync_invalid_argument_error] / ensure_last_error_from_table_sync_result_decision,
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_sync_backend_error] / ensure_last_error_from_table_sync_result_decision,
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_sync_model_invalid_error] / ensure_last_error_from_table_sync_result_decision,
        "errored"_s <= "table_sync_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [table_sync_unclassified_error_code] / ensure_last_error_from_table_sync_result_decision,
        "encode_prepare_result_decision"_s <= "encode_prepare_exec"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / run_prepare,
        "encode_merge_input_capacity_decision"_s <= "encode_prepare_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [prepare_result_ok],
        "errored"_s <= "encode_prepare_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [prepare_result_invalid_argument_error] / ensure_last_error_from_encode_prepare_result_decision,
        "errored"_s <= "encode_prepare_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [prepare_result_backend_error] / ensure_last_error_from_encode_prepare_result_decision,
        "errored"_s <= "encode_prepare_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [prepare_result_model_invalid_error] / ensure_last_error_from_encode_prepare_result_decision,
        "errored"_s <= "encode_prepare_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [prepare_result_unclassified_error_code] / ensure_last_error_from_encode_prepare_result_decision,
        "encode_merge_exec"_s <= "encode_merge_input_capacity_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_symbol_capacity_within_limit],
        "errored"_s <= "encode_merge_input_capacity_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_symbol_capacity_exceeded] / reject_invalid_encode_from_encode_merge_input_capacity_decision,
        "errored"_s <= "encode_merge_input_capacity_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / reject_invalid_encode_from_encode_merge_input_capacity_decision,
        "encode_merge_result_decision"_s <= "encode_merge_exec"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / run_merge,
        "encode_emit_input_decision"_s <= "encode_merge_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_result_ok],
        "errored"_s <= "encode_merge_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_result_invalid_argument_error] / ensure_last_error_from_encode_merge_result_decision,
        "errored"_s <= "encode_merge_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_result_backend_error] / ensure_last_error_from_encode_merge_result_decision,
        "errored"_s <= "encode_merge_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_result_model_invalid_error] / ensure_last_error_from_encode_merge_result_decision,
        "errored"_s <= "encode_merge_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [merge_result_unclassified_error_code] / ensure_last_error_from_encode_merge_result_decision,
        "encode_exec"_s <= "encode_emit_input_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [symbols_present],
        "encode_result_decision"_s <= "encode_emit_input_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [symbols_absent] / set_emit_result_empty,
        "errored"_s <= "encode_emit_input_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / ensure_last_error_from_encode_emit_input_decision,
        "emit_result_decision"_s <= "encode_exec"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / run_encode,
        "encode_result_decision"_s <= "emit_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [emit_result_ok] / apply_emit_result_ok,
        "encode_result_decision"_s <= "emit_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [emit_result_failed] / apply_emit_result_failed,
        "errored"_s <= "emit_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) / ensure_last_error_from_emit_result_decision,
        "done"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [encode_result_ok] / mark_done_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [encode_result_invalid_argument_error] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [encode_result_backend_error] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [encode_result_model_invalid_error] / ensure_last_error_from_encode_result_decision,
        "errored"_s <= "encode_result_decision"_s + completion<RuntimeEncodeRuntime>(RuntimeEncodeRuntime<'event>) [encode_result_unclassified_error_code] / ensure_last_error_from_encode_result_decision,
