...
sml! {
    TextJinjaParser<'event> {
        ...
        "tokenize_begin"_s <= "request_decision"_s + completion<EventParseRuntime<'event>> / begin_tokenization,
        "tokenize_next"_s <= "tokenize_begin"_s + completion<EventParseRuntime<'event>> / request_next_lex_token_from_tokenize_begin,
        "tokenize_result_decision"_s <= "tokenize_next"_s + completion<EventParseRuntime<'event>>,
        "program_parser_model"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [lexer_at_eof] / run_program_parser,
        "tokenize_append"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [lexer_has_token] / append_lex_token,
        "parse_result_decision"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_invalid_request] / commit_lex_error_from_tokenize_result_decision,
        "parse_result_decision"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_parse_failed] / commit_lex_error_from_tokenize_result_decision,
        "parse_result_decision"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_internal_error] / commit_lex_error_from_tokenize_result_decision,
        "parse_result_decision"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_untracked] / commit_lex_error_from_tokenize_result_decision,
        "parse_result_decision"_s <= "tokenize_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_unknown] / commit_lex_error_from_tokenize_result_decision,
        "tokenize_next"_s <= "tokenize_append"_s + completion<EventParseRuntime<'event>> / request_next_lex_token_from_tokenize_append,
        "parse_result_decision"_s <= "program_parser_model"_s + completion<EventParseRuntime<'event>>,
        "done"_s <= "parse_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_none] / dispatch_done,
        "errored"_s <= "parse_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_invalid_request] / dispatch_error_from_parse_result_decision,
        "errored"_s <= "parse_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_parse_failed] / dispatch_error_from_parse_result_decision,
        "errored"_s <= "parse_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_internal_error] / dispatch_error_from_parse_result_decision,
        "errored"_s <= "parse_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_untracked] / dispatch_error_from_parse_result_decision,
        "errored"_s <= "parse_result_decision"_s + completion<EventParseRuntime<'event>> [parse_error_unknown] / dispatch_error_from_parse_result_decision,
