...
/// Binds exactly one source-fixed Llama block in one dispatch.
#[derive(Clone, Copy, Debug)]
...
/// Installs the source-fixed Llama topology.
...
/// Visits the completed immutable Llama contract.
#[derive(Clone, Copy, Debug, Default)]
...
/// Looks up one validated Llama block.
#[derive(Clone, Copy, Debug)]
