//! Explicit Lfm2 family orchestration and child-outcome routing.
...
sml! {
    Lfm2Machine<'dispatch> {
        // Architecture binding and source-fixed global tensor inclusion.
        "state_begin_child"_s <= *"state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_1_2b] / effect_begin_child,
        "state_begin_child"_s <= "state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_230m] / effect_begin_child,
        "state_begin_child"_s <= "state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_validation] / effect_begin_child,
        ...
        // Exactly one guard-selected hybrid block and its opposite-family rejection per dispatch.
        "state_attention_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_pattern_attention] / effect_attention_child,
        "state_attention_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_fallback_attention] / effect_attention_child,
        "state_shortconv_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_pattern_shortconv] / effect_shortconv_child,
        "state_shortconv_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_fallback_shortconv] / effect_shortconv_child,
        "state_building"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_invalid] / effect_block_invalid,
        "state_reject_shortconv_child"_s <= "state_attention_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_child_ok] / effect_reject_shortconv_child,
        "state_reject_attention_child"_s <= "state_shortconv_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_child_ok] / effect_reject_attention_child,
        "state_building"_s <= "state_attention_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_child_error] / effect_child_error_block,
        "state_building"_s <= "state_shortconv_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_child_error] / effect_child_error_block,
        "state_building"_s <= "state_reject_shortconv_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_exclusion_child_ok] / effect_child_ok_block,
        "state_building"_s <= "state_reject_attention_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_exclusion_child_ok] / effect_child_ok_block,
        "state_block_reset_child"_s <= "state_reject_shortconv_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_exclusion_child_error] / effect_block_reset_child,
        "state_block_reset_child"_s <= "state_reject_attention_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_exclusion_child_error] / effect_block_reset_child,
        "state_bound"_s <= "state_block_reset_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_reset_ok] / effect_block_reset_complete,
        "state_bound"_s <= "state_block_reset_child"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_reset_error] / effect_block_reset_error,

        // Source-fixed topology and common plan construction.
        "state_topology_child"_s <= "state_building"_s + Topology(TopologyRuntime<'dispatch>) [guard_topology_pattern_valid] / effect_topology_pattern_child,
        "state_topology_child"_s <= "state_building"_s + Topology(TopologyRuntime<'dispatch>) [guard_topology_fallback_valid] / effect_topology_fallback_child,
