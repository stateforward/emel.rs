...
sml! {
    Gemma4Machine<'dispatch> {
        ...
        "state_begin_child"_s <= *"state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_profile_execution_valid] / effect_begin_profile_child,
        "state_begin_child"_s <= "state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_profile_validation_valid] / effect_begin_profile_child,
        "state_bound"_s <= "state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_architecture_invalid] / effect_begin_invalid_request,
        "state_bound"_s <= "state_bound"_s + Begin(BeginRuntime<'dispatch>) [guard_begin_profile_parameters_invalid] / effect_begin_model_invalid,
        ...
        // Full attention binds directly; sliding attention selects four source fallback facts.
        "state_block_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_dedicated_full] / effect_block_dedicated_full_child,
        "state_block_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_shared_full] / effect_block_shared_full_child,
        "state_block_child"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_shared_full_required_value] / effect_block_shared_full_required_value_child,
        "state_sliding_key_selected"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_sliding_key_swa] / effect_select_key_swa,
        "state_sliding_key_selected"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_sliding_key_fallback] / effect_select_key_fallback,
        "state_building"_s <= "state_building"_s + Block(BlockRuntime<'dispatch>) [guard_block_invalid] / effect_block_invalid,
        "state_sliding_value_selected"_s <= "state_sliding_key_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_value_swa] / effect_select_value_swa,
        "state_sliding_value_selected"_s <= "state_sliding_key_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_value_fallback] / effect_select_value_fallback,
        "state_sliding_rope_dimension_selected"_s <= "state_sliding_value_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_rope_dimension_swa] / effect_select_rope_dimension_swa,
        "state_sliding_rope_dimension_selected"_s <= "state_sliding_value_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_rope_dimension_fallback] / effect_select_rope_dimension_fallback,
        "state_sliding_rope_frequency_selected"_s <= "state_sliding_rope_dimension_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_rope_frequency_swa] / effect_select_rope_frequency_swa,
        "state_sliding_rope_frequency_selected"_s <= "state_sliding_rope_dimension_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_rope_frequency_fallback] / effect_select_rope_frequency_fallback,
        "state_block_child"_s <= "state_sliding_rope_frequency_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_selected_dedicated] / effect_block_selected_dedicated_child,
        "state_block_child"_s <= "state_sliding_rope_frequency_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_selected_shared] / effect_block_selected_shared_child,
        "state_block_child"_s <= "state_sliding_rope_frequency_selected"_s + completion<Block>(BlockRuntime<'dispatch>) [guard_block_selected_shared_required_value] / effect_block_selected_shared_required_value_child,
        ...
        // Explicit mixed shared-KV or all-dedicated topology and common plans.
        "state_topology_child"_s <= "state_building"_s + Topology(TopologyRuntime<'dispatch>) [guard_topology_shared_valid] / effect_topology_shared_child,
        "state_topology_child"_s <= "state_building"_s + Topology(TopologyRuntime<'dispatch>) [guard_topology_dedicated_valid] / effect_topology_dedicated_child,
        "state_building"_s <= "state_building"_s + Topology(TopologyRuntime<'dispatch>) [guard_topology_profile_invalid] / effect_topology_invalid,
