//! Explicit Qwen3 family orchestration and child-outcome routing.
...
sml! {
    Qwen3Machine<'dispatch> {
        ...
        // Exactly one source-fixed Q/K-normalized Qwen3 attention block per dispatch.
