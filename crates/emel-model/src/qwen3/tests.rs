...
#[test]
fn missing_optional_hparams_preserve_defaults() {
    ...
    assert_eq!(decoded.attention_key_length, 64);
    assert_eq!(decoded.attention_value_length, 80);
    assert_eq!(decoded.rope_dimension_count, 64);
