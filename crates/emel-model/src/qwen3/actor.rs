//! Public Qwen3 actor and private same-RTC dispatch runtimes.
...
pub struct Qwen3 {
    machine: Qwen3MachineStateMachine<Context>,
}
...
impl Qwen3 {
    ...
    pub fn new(
        ...
        Ok(Self {
            machine: Qwen3MachineStateMachine::new(Context {
                builder,
...
impl Qwen3MachineStateMachineContext for Context {
