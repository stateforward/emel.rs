...
sml! {
    DiarizationSortformerExecutor {
        ...
        "state_error_error_out_decision"_s <= "state_model_contract_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_model_contract_invalid] / effect_mark_model_invalid,
        "state_input_shape_decision"_s <= "state_tensor_contract_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_tensor_contract_valid],
        "state_error_error_out_decision"_s <= "state_tensor_contract_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_tensor_contract_invalid] / effect_mark_tensor_contract_invalid,
        "state_output_capacity_decision"_s <= "state_input_shape_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_input_shape_valid],
        "state_error_error_out_decision"_s <= "state_input_shape_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_input_shape_invalid] / effect_mark_input_shape_invalid,
        "state_binding"_s <= "state_output_capacity_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_output_capacity_valid] / effect_bind_contracts,
        "state_error_error_out_decision"_s <= "state_output_capacity_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_output_capacity_invalid] / effect_mark_output_capacity_invalid,
        "state_projecting"_s <= "state_binding"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) / effect_project_encoder,
        "state_transformer_cache"_s <= "state_projecting"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_write_projected_frames_to_cache,
        "state_error_error_out_decision"_s <= "state_projecting"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_00"_s <= "state_transformer_cache"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) / effect_execute_transformer_layer_00,
        "state_transformer_layer_01"_s <= "state_transformer_layer_00"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_01,
        "state_error_error_out_decision"_s <= "state_transformer_layer_00"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_02"_s <= "state_transformer_layer_01"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_02,
        "state_error_error_out_decision"_s <= "state_transformer_layer_01"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_03"_s <= "state_transformer_layer_02"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_03,
        "state_error_error_out_decision"_s <= "state_transformer_layer_02"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_04"_s <= "state_transformer_layer_03"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_04,
        "state_error_error_out_decision"_s <= "state_transformer_layer_03"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_05"_s <= "state_transformer_layer_04"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_05,
        "state_error_error_out_decision"_s <= "state_transformer_layer_04"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_06"_s <= "state_transformer_layer_05"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_06,
        "state_error_error_out_decision"_s <= "state_transformer_layer_05"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_07"_s <= "state_transformer_layer_06"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_07,
        "state_error_error_out_decision"_s <= "state_transformer_layer_06"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_08"_s <= "state_transformer_layer_07"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_08,
        "state_error_error_out_decision"_s <= "state_transformer_layer_07"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_09"_s <= "state_transformer_layer_08"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_09,
        "state_error_error_out_decision"_s <= "state_transformer_layer_08"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_10"_s <= "state_transformer_layer_09"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_10,
        "state_error_error_out_decision"_s <= "state_transformer_layer_09"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_11"_s <= "state_transformer_layer_10"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_11,
        "state_error_error_out_decision"_s <= "state_transformer_layer_10"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_12"_s <= "state_transformer_layer_11"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_12,
        "state_error_error_out_decision"_s <= "state_transformer_layer_11"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_13"_s <= "state_transformer_layer_12"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_13,
        "state_error_error_out_decision"_s <= "state_transformer_layer_12"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_14"_s <= "state_transformer_layer_13"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_14,
        "state_error_error_out_decision"_s <= "state_transformer_layer_13"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_15"_s <= "state_transformer_layer_14"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_15,
        "state_error_error_out_decision"_s <= "state_transformer_layer_14"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_16"_s <= "state_transformer_layer_15"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_16,
        "state_error_error_out_decision"_s <= "state_transformer_layer_15"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_transformer_layer_17"_s <= "state_transformer_layer_16"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_execute_transformer_layer_17,
        "state_error_error_out_decision"_s <= "state_transformer_layer_16"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_publishing_hidden"_s <= "state_transformer_layer_17"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok] / effect_publish_hidden,
        "state_error_error_out_decision"_s <= "state_transformer_layer_17"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_failed],
        "state_success_error_out_decision"_s <= "state_publishing_hidden"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_execution_ok],
        "state_success_callback_decision"_s <= "state_success_error_out_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_has_error_out] / effect_store_success_error,
        "state_success_callback_decision"_s <= "state_success_error_out_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_no_error_out],
        "state_error_callback_decision"_s <= "state_error_error_out_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_has_error_out] / effect_store_error_error,
        "state_error_callback_decision"_s <= "state_error_error_out_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_no_error_out],
        "state_done"_s <= "state_success_callback_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_has_done_callback] / effect_emit_done,
        "state_done"_s <= "state_success_callback_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_no_done_callback],
        "state_errored"_s <= "state_error_callback_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_has_error_callback] / effect_emit_error,
        "state_errored"_s <= "state_error_callback_decision"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>) [guard_no_error_callback],
        "state_ready"_s <= "state_done"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>),
        "state_ready"_s <= "state_errored"_s + completion<EventExecuteRun>(&'dispatch EventExecuteRun<'dispatch>),
