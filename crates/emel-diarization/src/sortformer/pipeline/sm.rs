...
sml! {
    DiarizationSortformerPipeline {
        "state_model_contract_decision"_s <= *"state_ready"_s + event<EventRunFlow<'dispatch>>(&'dispatch EventRunFlow<'dispatch>) / effect_begin_run,
        "state_sample_rate_decision"_s <= "state_model_contract_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_model_contract_valid],
        "state_publish_error"_s <= "state_model_contract_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_model_contract_invalid] / effect_mark_model_invalid,
        "state_channel_count_decision"_s <= "state_sample_rate_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_sample_rate_valid],
        "state_publish_error"_s <= "state_sample_rate_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_sample_rate_invalid] / effect_mark_sample_rate_invalid,
        "state_pcm_shape_decision"_s <= "state_channel_count_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_channel_count_valid],
        "state_publish_error"_s <= "state_channel_count_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_channel_count_invalid] / effect_mark_channel_count_invalid,
        "state_probability_capacity_decision"_s <= "state_pcm_shape_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_pcm_shape_valid],
        "state_publish_error"_s <= "state_pcm_shape_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_pcm_shape_invalid] / effect_mark_pcm_shape_invalid,
        "state_segment_capacity_decision"_s <= "state_probability_capacity_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_probability_capacity_valid],
        "state_publish_error"_s <= "state_probability_capacity_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_probability_capacity_invalid] / effect_mark_probability_capacity_invalid,
        "state_tensor_contract_decision"_s <= "state_segment_capacity_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_segment_capacity_valid],
        "state_publish_error"_s <= "state_segment_capacity_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_segment_capacity_invalid] / effect_mark_segment_capacity_invalid,
        "state_preparing_features"_s <= "state_tensor_contract_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_tensor_contract_valid],
        "state_publish_error"_s <= "state_tensor_contract_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_tensor_contract_invalid] / effect_mark_tensor_contract_invalid,
        "state_prepare_decision"_s <= "state_preparing_features"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_prepare_features,
        "state_binding_encoder"_s <= "state_prepare_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_no_error],
        "state_publish_error"_s <= "state_prepare_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_has_error],
        "state_computing_encoder"_s <= "state_binding_encoder"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_bind_encoder,
        "state_executing_hidden"_s <= "state_computing_encoder"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_encoder_kernel_ready] / effect_compute_encoder_frames,
        "state_publish_error"_s <= "state_computing_encoder"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_encoder_kernel_unavailable] / effect_mark_kernel_error_from_state_computing_encoder,
        "state_encoder_compute_decision"_s <= "state_executing_hidden"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_encoder_compute_succeeded],
        "state_publish_error"_s <= "state_executing_hidden"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_encoder_compute_failed],
        "state_execute_decision"_s <= "state_encoder_compute_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_execute_hidden,
        "state_binding_modules"_s <= "state_execute_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_no_error],
        "state_publish_error"_s <= "state_execute_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_has_error],
        "state_computing_probabilities"_s <= "state_binding_modules"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_bind_modules,
        "state_probability_decision"_s <= "state_computing_probabilities"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_probability_kernel_ready] / effect_compute_probabilities,
        "state_publish_error"_s <= "state_computing_probabilities"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_probability_kernel_unavailable] / effect_mark_kernel_error_from_state_computing_probabilities,
        "state_probability_compute_decision"_s <= "state_probability_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_probability_compute_succeeded],
        "state_publish_error"_s <= "state_probability_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) [guard_probability_compute_failed],
        "state_decoding_segments"_s <= "state_probability_compute_decision"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>),
        "state_publish_success"_s <= "state_decoding_segments"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_decode_segments,
        "state_done"_s <= "state_publish_success"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_publish_success,
        "state_errored"_s <= "state_publish_error"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>) / effect_publish_error,
        "state_ready"_s <= "state_done"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>),
        "state_ready"_s <= "state_errored"_s + completion<EventRunFlow>(&'dispatch EventRunFlow<'dispatch>),
