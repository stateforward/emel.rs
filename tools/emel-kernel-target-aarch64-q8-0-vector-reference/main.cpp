...
int main() {
  ...
  std::cout << "kernel-target-aarch64-q8-0-vector-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
            ...
            << "\ntarget_arch=aarch64\nscope=target_router_q8_0_vector_m5_k32_and_typed_rejection\nexecution=split_pinned_aarch64_sm_and_public_target_router\n";
  ...
  std::cout << "case=q8_0_vector_m5_k32 status=ok output_bits=";
  write_bits(output);
  std::cout << '\n';
