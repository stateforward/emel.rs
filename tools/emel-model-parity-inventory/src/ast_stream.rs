...
struct Location {
    ...
    offset: Option<u64>,
    tok_len: Option<u64>,
    spelling_loc: Option<Box<Location>>,
}
...
{"kind":"NamespaceDecl","name":"emel_window_test"}"#;
    ...
    fn redeclaration_identity_keeps_definition_canonical_and_declarations_exact() {
        ...
        assert_eq!(definition, "emel::event::bind_storage");
        assert_eq!(first, "emel::event::bind_storage::<declaration@58:8>");
    }
