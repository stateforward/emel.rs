...
use emel_model::generation::quantized_path::{Outcome, Resolver, Scope, event::Query};
...
fn write_parity() -> Result<(), emel_model::generation::quantized_path::Error> {
...
fn run_queries(
    ...
    iterations: u32,
) -> Result<(), emel_model::generation::quantized_path::Error> {
