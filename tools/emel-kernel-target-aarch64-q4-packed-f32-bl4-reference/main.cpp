...
int main() {
  ...
  std::cout << "kernel-target-aarch64-q4-packed-f32-bl4-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
            ...
            << "\ntarget_arch=aarch64\nscope=target_router_q4_packed_f32_bl4_m5_k256_and_typed_rejection\nexecution=split_pinned_aarch64_sm_and_public_target_router\n";
  ...
  std::cout << "case=q4_packed_f32_bl4_m5_k256 status=ok output_bits=";
  write_bits(output);
  std::cout << '\n';
  ...
  invalid.src0 = view(zero.data(), emel::kernel::event::dtype::q4_k_x8_bl4,
                      {0, 0, 1, 1}, {1, 0, 0, 0});
  invalid.src1 =
      view(zero.data(), emel::kernel::event::dtype::f32, {1, 0, 1, 1}, {4, 0, 0, 0});
  ...
  invalid.src1 = view(rhs.data(), emel::kernel::event::dtype::f32, {1, 0, 1, 1},
                      {4, 4, 0, 0});
