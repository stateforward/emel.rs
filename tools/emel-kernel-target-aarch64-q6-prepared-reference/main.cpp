...
#error "q6 prepared observer requires the live i8mm path"
#endif
...
int main() {
  ...
  std::cout << "kernel-target-aarch64-q6-prepared-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
            ...
            << "\ntarget_arch=aarch64\nscope=target_router_q6_prepared_m5_k256_and_typed_rejection\nexecution=split_pinned_aarch64_sm_and_public_target_router\nlive_path=execute_neon_mul_mat_q6_vector_prepared_q8_rhs_i8mm\n";
  ...
  std::cout << "case=q6_prepared_m5_k256 status=ok output_bits=";
  write_bits(output);
  std::cout << '\n';
