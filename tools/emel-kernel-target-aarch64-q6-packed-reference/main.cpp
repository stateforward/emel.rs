...
int main() {
  ...
  std::cout << "kernel-target-aarch64-q6-packed-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
  ...
  std::cout << "case=q6_packed_m5_k256 status=ok output_bits=";
  write_bits(output);
  std::cout << '\n';
