...
int main() {
  ...
  std::cout << "kernel-target-aarch64-q6-packed-argmax-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
            ...
            << "\ntarget_arch=aarch64\nscope=target_router_q6_packed_argmax_m5_k256_and_typed_rejection\nexecution=split_pinned_aarch64_sm_and_public_target_router\n";
  ...
  std::cout << "case=q6_packed_argmax_m5_k256 status=ok output_bits=";
  write_bits(output);
  std::cout << " index=" << index << '\n';

  std::array<float, 1> zero = {k_sentinel};
  std::int32_t zero_index = k_index_sentinel;
