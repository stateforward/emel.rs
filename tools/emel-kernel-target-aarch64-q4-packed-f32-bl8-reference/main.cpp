...
int main() {
  ...
  std::cout << "kernel-target-aarch64-q4-packed-f32-bl8-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
            ...
            << "\ntarget_arch=aarch64\nscope=target_router_q4_packed_f32_bl8_m5_k256_and_typed_rejection\nexecution=split_pinned_aarch64_sm_and_public_target_router\n";
  ...
  std::cout << "case=q4_packed_f32_bl8_m5_k256 status=ok output_bits=";
  write_bits(output);
  std::cout << '\n';
