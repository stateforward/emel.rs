...
int main() {
  ...
  if (!::emel::kernel::detail::quant::pack_q8_0_rows_x4_bl4(src_rows.data(), m, k,
                                                            lhs.data())) {
    return 1;
  }
  ...
  std::cout << "kernel-target-aarch64-q8-0-x4-bl4-live/v1\nsource_repository=stateforward/emel.cpp\nsource_commit="
  ...
  std::cout << "case=q8_0_packed_bl4_m5_k32 status=ok output_bits=";
  write_bits(output);
  std::cout << '\n';
  ...
  invalid.src0 =
      view(zero.data(), emel::kernel::event::dtype::q8_0_x4_bl4, {0, 0, 1, 1}, {1, 0, 0, 0});
  ...
  invalid.src0 = view(lhs.data(), emel::kernel::event::dtype::q8_0_x4_bl4, {31, m, 1, 1},
                      {1, group_bytes, group_bytes * group_count, group_bytes * group_count});
